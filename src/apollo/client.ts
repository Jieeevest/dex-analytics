...
export const litedexClient = new ApolloClient({
  // uri: 'https://api.thegraph.com/subgraphs/name/jieeevest/subtest',
  uri: 'https://api.thegraph.com/subgraphs/name/jieeevest/litedex-data',
  cache: new InMemoryCache({
    typePolicies: {
      Token: {
...
export const traderJoeClient = new ApolloClient({
...
export const biswapClient = new ApolloClient({
  uri: 'https://api.thegraph.com/subgraphs/name/jieeevest/biswap-exchange',
  cache: new InMemoryCache({
    typePolicies: {
      Token: {
        // Singleton types that have no identifying field can use an empty
