...
export const ButtonPrimary = styled(Base)<{ bgColor?: string }>`
  ...
  color: white;
  &:focus {
    box-shadow: 0 0 0 1pt ${({ theme, bgColor }) => bgColor ?? theme.btnPrimaryHover};
    background-color: ${({ theme, bgColor }) => bgColor ?? theme.btnPrimaryHover};
  }
  &:hover {
    background-color: ${({ theme, bgColor }) => bgColor ?? theme.btnPrimaryHover};
  }
  &:active {
    box-shadow: 0 0 0 1pt ${({ theme, bgColor }) => darken(0.4, bgColor ?? theme.primary1)};
    background-color: ${({ theme, bgColor }) => darken(0.4, bgColor ?? theme.primary1)};
  }
  &:disabled {
...
export const ButtonOutlinePrimary = styled(Base)<{ bgColor?: string }>`
...
export const SavedIcon = ({
  ...
  return (
    <HoverIcon {...rest}>
      <Star stroke={theme.primary1} fill={fill ? theme.primary1 : 'transparent'} size={size} />
    </HoverIcon>
  )
}
...
export const SmallOptionButton = styled(Base)<{ active?: boolean }>`
  ...
  ${(active) =>
    active &&
    css`
      border: 1px solid ${({ theme }) => theme.shadowBrand};
    `}
