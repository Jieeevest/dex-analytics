    ...
    <Hotkeys keyName="command+/" onKeyDown={handleDown}>
      ...
      <Container>
        <Wrapper {...rest}>
          ...
          />
          {!focused && <TYPE.darkGray pl="2px">⌘/</TYPE.darkGray>}
        </Wrapper>
                ...
                return (
                  <HoverRowLink onClick={() => handleNav(networkPrefix(activeNetwork) + 'tokens/' + t.address)} key={i}>
                    <ResponsiveGrid>
                      ...
                      <HideSmall>
                        <TYPE.label textAlign="end">{formatDollarAmount(t.liquidityUSD)}</TYPE.label>
                      </HideSmall>
                      <HideSmall>
                ...
                return (
                  <HoverRowLink onClick={() => handleNav(networkPrefix(activeNetwork) + 'pools/' + p.address)} key={i}>
                    <ResponsiveGrid key={i}>
                      ...
                      <HideSmall>
                        <TYPE.label textAlign="end">{formatDollarAmount(p.liquidityUSD)}</TYPE.label>
                      </HideSmall>
                      <HideSmall>
