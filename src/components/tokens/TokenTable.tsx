  ...
  return (
    <LinkWrapper to={'tokens/' + tokenData.address}>
      <ResponsiveGrid>
        ...
        <Label end={1} fontWeight={400}>
          {formatDollarAmount(tokenData.liquidityUSD)}
        </Label>
      </ResponsiveGrid>
    </LinkWrapper>
  )
      ...
      {sortedTokens.length > 0 ? (
        <AutoColumn gap="16px">
          <ResponsiveGrid>
            ...
            <ClickableText color={theme.text2} end={1} onClick={() => handleSort(SORT_FIELD.liquidityUSD)}>
              TVL {arrow(SORT_FIELD.liquidityUSD)}
            </ClickableText>
          </ResponsiveGrid>
