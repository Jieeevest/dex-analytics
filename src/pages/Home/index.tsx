...
import { DarkGreyCard, DarkOutlineCard } from 'components/Card'
...
export default function Home() {
  ...
  const tvlValue = useMemo(() => {
    ...
    return formatDollarAmount(protocolData?.liquidityUSD, 2, true)
  }, [liquidityHover, protocolData?.liquidityUSD])

  return (
    <PageWrapper>
      {/* <ThemedBackgroundGlobal backgroundColor={activeNetwork.bgColor} /> */}
      <AutoColumn gap="16px">
        <TYPE.main>Litedex Overview</TYPE.main>
        <ResponsiveRow>
          <ChartWrapper>
            <LineChart
              ...
              topLeft={
                <AutoColumn gap="4px">
                  <TYPE.mediumHeader fontSize="16px">Total Value Locked</TYPE.mediumHeader>
        ...
        <RowBetween>
          ...
          <CustomInternalLink to="tokens">Explore</CustomInternalLink>
        </RowBetween>
        <TokenTable tokenDatas={formattedTokens} />
        <RowBetween>
          <TYPE.main>Top Pools</TYPE.main>
          <CustomInternalLink to="pools">Explore</CustomInternalLink>
        </RowBetween>
...
const CustomInternalLink = styled(StyledInternalLink)`
  text-decoration: underline ${({ theme }) => theme.primary1};
